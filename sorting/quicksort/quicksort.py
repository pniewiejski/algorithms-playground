...
# Here the operations on sub-arrays are simplified by python's list comprehension.
# Because of this one might argue that this is not a _proper_ quicksort implementation
# but I think it shows the idea of a pivot and sub-arrays in a very simple way and that was the point.
